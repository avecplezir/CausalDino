...
default_cfgs = {
   ...
   'svt_vit_base_patch16_224': _cfg(
    ...
    'vit_mae_base_patch16_224': _cfg(
       ...
       mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225),
       name='vit_mae_base_patch16_224',
    ),
    'vit_mae_large_patch16_224': _cfg(
       url="https://dl.fbaipublicfiles.com/mae/pretrain/mae_pretrain_vit_large.pth",
       yt_path='//home/yr/ianokhin/CausalDino/pretrain/mae_pretrain_vit_large.pth',
       mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225),
       name='vit_mae_large_patch16_224',
    ),
}
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        # self.feature_head = True
        # if self.feature_head:
        #     self.feature_head = nn.Linear(embed_dim, 256)
        #     self.embed_dim = 256
...
def get_deit_small_patch16_224(cfg, patch_size=16, no_head=False, **kwargs):
    ...
    elif kwargs.get('default_cfg') == 'none':
        vit.default_cfg = None
