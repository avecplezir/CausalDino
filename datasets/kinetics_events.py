...
class KineticsEvents(torch.utils.data.Dataset):
    """
    ...
    def __init__(self, cfg, mode, num_retries=10, get_flow=False, extension='avi'):
        """
        ...
        self._path_to_videos = glob.glob(self.cfg.DATA.PATH_TO_DATA_DIR + '/*' + '.' + extension)
