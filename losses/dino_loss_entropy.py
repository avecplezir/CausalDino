...
class DINOLossEntropy(nn.Module):
    ...
    def forward(self, student_output, teacher_output, epoch, **kwargs):
        ...
        batch_entropy_loss = -torch.sum(F.softmax(self.center, dim=-1) * F.log_softmax(batch_center), dim=-1)
        ...
        total_loss = CE - batch_entropy_loss
